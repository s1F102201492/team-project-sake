...
from django.contrib.auth.models import User # Django標準のUserモデルを利用
...
class Event(models.Model):
    ...
    organizer = models.ForeignKey(User, on_delete=models.CASCADE) # 主催者
    sakes_featured = models.ManyToManyField(Sake, blank=True) # イベントで提供されるお酒
